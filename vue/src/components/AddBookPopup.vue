  ...
  <div class="add-book-popup" v-if="!isHidden">
    ...
    >
      <div class="add-input">
        ...
        <input type="text" name="title" size="30" v-model="title" />
      </div>
      <div class="add-input">
        <label for="author">Author: </label>
        <input type="text" name="author" size="30" v-model="author" />
      </div>
      <div class="add-input">
        <label for="publishingHouse">Publishing house: </label>
        <input type="text" name="house" size="30" v-model="publishingHouse" />
      </div>
      <div class="add-input">
      ...
      <div class="add-input">
        ...
        <input type="text" size="30" v-model="image" />
      </div>
    </form>
